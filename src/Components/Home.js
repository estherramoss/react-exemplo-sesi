...
const Home = () => {
  return (
    <Container>
      {/* Em react, "wrapper" é um termo comujnmente usado para se referir a um componente que envolve
      (wraps) um ou mais outros componentes. */ }
      {/* Wrapper para o cinteúdo de texto */}
      <ContentWrapper>
